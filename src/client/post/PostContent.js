...
class PostContent extends React.Component {
  ...
  render() {
    ...
    const opcHost = appUrl || 'https://opc.org';
    let canonicalHost = opcHost;
    ...
    const url = `${opcHost}${dropCategory(content.url)}`;
    const ampUrl = `${url}/amp`;
    const metaTitle = `${title} - opc`;
    ...
    return (
      <div>
        <Helmet>
          ...
          <meta property="twitter:site" content={'@opcorg'} />
