    ...
    return (
      ...
      >
        <div className="LoginModal__body">
          <i className="iconfont icon-opc LoginModal__icon" />
          <span className="LoginModal__login-title">
            <FormattedMessage id="login_to_opc" defaultMessage="Login to opc" />
          </span>
          <span className="LoginModal__login-description">
            <FormattedMessage
              id="login_modal_description"
              defaultMessage="Login with your Steem account using SteemConnect to enjoy opc at 100%"
            />
          </span>
